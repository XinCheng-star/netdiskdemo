...
public interface UserDiskCapacityTableMapper {
    ...
    UserDiskCapacityTable selectByAccount(String account);
    ...
    @Update({
            "update user_disk_capacity_table",
            "set " +
                    "used_disk = used_disk + #{addSize,jdbcType=DOUBLE},",
            "modify_time = now()",
            "where account = #{account,jdbcType=VARCHAR}"
    })
    int updateByAccountAddUsedSize(String account, Double addSize);
}